                ...
                <div class="col-lg-12">
                    <div class="welcome-wrap text-center">
                        <div class="section-title1 text-center wow fadeInUp" data-wow-delay="200ms">
                            ...
                            <h2>Welcome To Satyam Motors</h2>
                        </div>
                        <div class="welcome-content wow fadeInUp" data-wow-delay="300ms">
                            <p>We're passionate car agency<br>
                                ...
                                things automotive, you've come to the right place.At Satyam Motors, we strive to create
                                a space where people can connect, share knowledge, and explore the exciting world of
                                ...
                                Buckle up and enjoy your journey with Satyam Motors!</p>
                        </div>
            ...
            <div class="row g-4 mb-50">
                <div class="col-lg-4 col-sm-6 wow fadeInUp" data-wow-delay="200ms" data-wow-duration="1500ms">
                    <div class="gallery-item">
                        <img class="img-fluid" src="assets/img/inner-page/gallery-01.png" alt="gallery">
                        <a href="assets/img/inner-page/gallery-01.png" data-fancybox="gallery"
                ...
                <div class="col-lg-4 col-sm-6 d-flex align-items-end wow fadeInUp" data-wow-delay="300ms"
                    ...
                    <div class="gallery-item">
                        <img class="img-fluid" src="assets/img/inner-page/gallery-02.png" alt="gallery">
                        <a href="assets/img/inner-page/gallery-02.png" data-fancybox="gallery"
                            class="gallary-item-overlay"></a>
                    </div>
                </div>
                <div class="col-lg-4 col-sm-6 wow fadeInUp" data-wow-delay="400ms" data-wow-duration="1500ms">
                    <div class="gallery-item">
                        <img class="img-fluid" src="assets/img/inner-page/gallery-03.png" alt="gallery">
                        <a href="assets/img/inner-page/gallery-03.png" data-fancybox="gallery"
                            class="gallary-item-overlay"></a>
                    </div>
                </div>
                <div class="col-lg-4 col-sm-6 wow fadeInUp" data-wow-delay="500ms" data-wow-duration="1500ms">
                    <div class="gallery-item">
                        <img class="img-fluid" src="assets/img/inner-page/gallery-04.png" alt="gallery">
                        <a href="assets/img/inner-page/gallery-04.png" data-fancybox="gallery"
                            class="gallary-item-overlay"></a>
                    </div>
                </div>
                <div class="col-lg-4 col-sm-6 d-flex align-items-start wow fadeInUp" data-wow-delay="600ms"
                    data-wow-duration="1500ms">
                    <div class="gallery-item">
                        <img class="img-fluid" src="assets/img/inner-page/gallery-05.png" alt="gallery">
                        <a href="assets/img/inner-page/gallery-05.png" data-fancybox="gallery"
                            class="gallary-item-overlay"></a>
                    </div>
                </div>
                <div class="col-lg-4 col-sm-6 wow fadeInUp" data-wow-delay="700ms" data-wow-duration="1500ms">
                    <div class="gallery-item">
                        <img class="img-fluid" src="assets/img/inner-page/gallery-06.png" alt="gallery">
                        <a href="assets/img/inner-page/gallery-06.png" data-fancybox="gallery"
                            class="gallary-item-overlay"></a>
                    </div>
                </div>
            </div>
