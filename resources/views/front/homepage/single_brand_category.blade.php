                    ...
                    <div class="row">
                        <div class="col-xl-6 col-lg-7 d-flex align-items-center">
                            <div class="banner-content">
                                <span class="sub-title">{{ $brand->name }}</span>
                                <h1>To Choose {{ $brand->name }} Car</h1>
                        ...
                        <div class="col-xl-6 col-lg-5 d-lg-flex d-none align-items-center justify-content-end">
                            <div class="banner-img">
                                <img src="{{ asset('uploads/' . $brand->icon) }}" alt>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="col-xl-3 col-lg-4 col-md-6">
                            <div class="product-card">
                                ...
                                <div class="product-content">
                                    <h5><a href="{{ route('car_details', ['id' => $item->id]) }}">{{ $item->name }}</h5>
