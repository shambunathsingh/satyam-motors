            ...
            <form>
                <div class="form-inner">
                    <select>
                        ...
                        <option value="3">Recondition</option>
                    </select>
                </div>
                <div class="form-inner">
                    <select>
                ...
                <div class="form-inner">
                    <select>
                        <option value="1">Altima S-2023</option>
                        <option value="2">Camry-2022</option>
                        <option value="3">Benz-2023</option>
                        <option value="4">CX-5-2023</option>
                        <option value="5">A4-2023</option>
                    </select>
                </div>
                <div class="form-inner">
                    <select>
                        ...
                        <option value="5">25000-300</option>
                    </select>
                </div>
                <div class="form-inner">
    ...
    <div class="sidebar-menu">
        ...
        <ul class="menu-list">
            <li class="menu-item-has-children active">
                <a href="javascript:void(0);" class="drop-down">Home</a><i class="bi bi-plus dropdown-icon"></i>
                <ul class="sub-menu">
...
<li> -->
            ...
            <div class="row gy-5">
                <div class="col-lg-6 wow fadeInLeft" data-wow-delay="300ms">
                    ...
                    <div class="explore-btn">
                        <a href="{{ route('b_category') }}">Explore All Category <i
                                class="bi bi-arrow-right"></i></a>
                    </div>
                </div>
                            ...
                            <div class="row">
                                    ...
                                    <div class="form-inner">
                                        ...
                                        <div class="swiper categoty-filter-slider">
                                            <div class="swiper-wrapper">
                                                <div class="swiper-slide select-wrap selected">
                                                    <div class="single-category">
                                                        <div class="check-icon">
                                                            <img src="assets/img/home4/icon/check.svg" alt>
                                                        </div>
                                                        <div class="icon">
                                                            <img src="assets/img/home4/icon/sedan.svg" alt>
                                                        </div>
                                                        <h6>Sedan</h6>
                                                    </div>
                                                </div>
                                                <div class="swiper-slide select-wrap">
                                                    <div class="single-category">
                                                        ...
                                                        <div class="icon">
                                                            <img src="assets/img/home4/icon/suv%27s.svg" alt>
                                                        </div>
                                                        <h6>SUV’s</h6>
                                                    </div>
                                                </div>
                                                <div class="swiper-slide select-wrap">
                                                    <div class="single-category">
                                                        ...
                                                        <div class="icon">
                                                            <img src="assets/img/home4/icon/truck.svg" alt>
                                                        </div>
                                                        <h6>Truck</h6>
                                                    </div>
                                                </div>
                                ...
                                <div class="col-md-6 mb-15">
                                    <div class="form-inner">
                                        <label>Model*</label>
                                        <select class="js-example-basic-single" name="state">
                                            <option value="1">RS e tron GT</option>
                                ...
                                <div class="col-lg-12">
                                    <div class="advanced-btn">
                                        <button type="button" data-bs-toggle="modal"
                                            data-bs-target="#adSearchModal01">
                                            Advanced Filter
    ...
    <div class="home3-latest-car-section mb-100 pt-90 pb-90">
        <div class="container">
            <div class="row mb-50 wow fadeInUp" data-wow-delay="200ms">
            ...
            <div class="row">
                                ...
                                <div class="product-card4">
                                    ...
                                    <div class="product-content">
                                        ...
                                        <div class="button-and-price">
                                            <a class="primary-btn3" href="{{route('car_details')}}">View Details</a>
                ...
                <div class="col-lg-12 d-flex justify-content-center wow fadeInUp" data-wow-delay="400ms">
    ...
    <div class="home4-featured-car-area mb-100">
        <div class="container">
            <div class="row mb-50 wow fadeInUp" data-wow-delay="200ms">
                <div class="col-lg-12 d-flex align-items-end justify-content-between gap-3 flex-wrap">
                    <div class="section-title-2">
            ...
            <div class="row">
                ...
                <div class="col-lg-12 d-flex justify-content-center wow fadeInUp" data-wow-delay="400ms">
                    <div class="slider-btn-pagination">
                        <div class="slider-btn prev-12"><i class="bi bi-arrow-left"></i></div>
                        <div class="pagination pagination12"></div>
                        <div class="slider-btn next-12"><i class="bi bi-arrow-right"></i></div>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            <div class="row mb-50 wow fadeInUp" data-wow-delay="200ms">
                <div class="col-lg-12 d-flex justify-content-center">
                    <div class="section-title-2 text-center">
                        <h2>Why Only Choose Satyam Motors</h2>
                        <p>To get the most accurate and up-to-date information.</p>
                    </div>
                </div>
            </div>
    ...
    <div class="home4-used-car-section mb-100">
        <div class="container">
            <div class="row mb-50 wow fadeInUp" data-wow-delay="200ms">
                <div class="col-lg-12 d-flex align-items-end justify-content-between gap-3 flex-wrap">
                    <div class="section-title-2">
    ...
    <div class="home4-inner-banner-section mb-100">
        <div class="container">
            <div class="row gy-5">
                <div class="col-lg-6 d-flex align-items-center">
                    <div class="section-title-2 wow fadeInUp" data-wow-delay="200ms">
                        <h2>Sell Your Car With Satyam Motors?</h2>
                        ...
                        <div class="sell-btn-and-contact-info">
                            <button class="primary-btn3" type="button" data-bs-toggle="modal"
    ...
    <div class="home4-upcomming-car-section mb-100">
        <div class="modal signUp-modal fade" id="alartModal01" tabindex="-1"
            aria-labelledby="alartModal01Label" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    <div class="modal-header">
                            ...
                            <div class="swiper-slide">
                                <div class="product-card4 style-2">
                                    ...
                                    <div class="product-content">
                                        ...
                                        <div class="button-and-price">
                                            <button type="button" class="primary-btn3" data-bs-toggle="modal"
    ...
    <div class="home2-testimonial-section mb-100">
        <div class="container">
            ...
            <div class="row wow fadeInUp" data-wow-delay="300ms">
                <div class="col-lg-12 mb-40">
                    <div class="swiper customer-feedback-slider4">
                        <div class="swiper-wrapper">
                            <div class="swiper-slide">
                                <div class="feedback-card">
                                    ...
                                    <p><strong>Satyam-Motors</strong> customer feedback is an invaluable source of
                ...
                <div class="col-lg-12 d-flex justify-content-center">
                    <div class="slider-btn-pagination">
                        <div class="slider-btn prev-6"><i class="bi bi-arrow-left"></i></div>
                        <div class="pagination pagination8"></div>
                        <div class="slider-btn next-6"><i class="bi bi-arrow-right"></i></div>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row g-4 justify-content-center">
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="200ms">
                    <div class="news-card style-2">
                        <div class="news-img">
                            <a href="{{ route('blog_detail') }}"><img src="assets/img/home1/news-01.png" alt></a>
                            <div class="date">
                                <a href="{{ route('blog_standard') }}">Buying Advice</a>
                            </div>
                        </div>
                        <div class="content">
                            <h6><a href="{{ route('blog_detail') }}">The Car Enthusiast: Exploring the World of Cars and
                                    Driving.</a>
                            </h6>
                            <div class="news-btm d-flex align-items-center justify-content-between">
                                <div class="author-area">
                                    ...
                                    <div class="author-content">
                                        ...
                                        <a href="{{ route('blog_standard') }}">Posted on - 03 April, 2023</a>
                                    </div>
                                </div>
                ...
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="300ms">
                    <div class="news-card style-2">
                        <div class="news-img">
                            <a href="{{ route('blog_detail') }}"><img src="assets/img/home1/news-02.png" alt></a>
                            <div class="date">
                                <a href="{{ route('blog_standard') }}">Car Advice</a>
                            </div>
                        </div>
                        <div class="content">
                            <h6><a href="{{ route('blog_detail') }}">The Best Car Brands for Performance and Reliability.</a>
                            </h6>
                            <div class="news-btm d-flex align-items-center justify-content-between">
                                <div class="author-area">
                                    <div class="author-img">
                ...
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="400ms">
                    <div class="news-card style-2">
                        <div class="news-img">
                            <a href="{{ route('blog_detail') }}"><img src="assets/img/home1/news-03.png" alt></a>
                            <div class="date">
                                <a href="{{ route('blog_standard') }}">Driving Advice</a>
                            </div>
                        </div>
                        <div class="content">
                            <h6><a href="{{ route('blog_detail') }}">The Environmental Impact of Cars and How to Minimize
                                    It.</a>
                            </h6>
                            <div class="news-btm d-flex align-items-center justify-content-between">
                                <div class="author-area">
        ...
        <div class="container-fluid">
                    ...
                    <div class="col d-flex justify-content-xl-end justify-content-sm-center">
                        <div class="footer-widget">
                            ...
                            <div class="app-download">
                                <ul>
                                    <li>
                                        <a href="#"><img src="assets/img/home1/icon/google-app.svg" alt></a>
                                    </li>
                                    <li>
                                        <a href="#"><img src="assets/img/home1/icon/apple-app.svg" alt></a>
                                    </li>
                                </ul>
                            </div>
                        </div>
                ...
                <div class="contact-area">
                    ...
                    <div class="hotline-area">
                        ...
                        <div class="content">
                            ...
                            <h6><a
                                    href="https://demo-egenslab.b-cdn.net/cdn-cgi/l/email-protection#40292e262f00272d21292c6e232f2d"><span
                                        class="__cf_email__"
                                        data-cfemail="3c55525a537c5b515d5550125f5351">[email&#160;protected]</span></a>
                            </h6>
                        </div>
                    </div>
                </div>
            ...
            <div class="footer-btm">
                <div class="copyright-area">
                    <p>Copyright 2024 <a href="#">Satyam Motors</a> | Design By <a href="#">Textifly</a>
                    </p>
                </div>
                <div class="social-area">
                    <h6>Follow Satyam Motors:</h6>
                    <ul>
