            ...
            <div class="row g-4 justify-content-center">
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="200ms">
                    <div class="news-card style-2">
                        ...
                        <div class="content">
                            <h6><a href="{{ route('blog_detail') }}">The Car Enthusiast: Exploring the World of Cars
                                    and
                                    Driving.</a>
                            </h6>
                ...
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="300ms">
                    <div class="news-card style-2">
                        ...
                        <div class="content">
                            <h6><a href="{{ route('blog_detail') }}">The Best Car Brands for Performance and
                                    Reliability.</a>
                            </h6>
                            <div class="news-btm d-flex align-items-center justify-content-between">
                                <div class="author-area">
                ...
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="400ms">
                    <div class="news-card style-2">
                        ...
                        <div class="content">
                            <h6><a href="{{ route('blog_detail') }}">The Environmental Impact of Cars and How to
                                    Minimize
                                    It.</a>
                            </h6>
                            <div class="news-btm d-flex align-items-center justify-content-between">
