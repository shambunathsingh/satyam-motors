    ...
    <div class="page-content " style="min-height: 758px;">
        ...
        <div id="main">
            ...
            <div class="breadcambarea">
                ...
                <div class="portlet light bpaymented portlet-no-padding">
                        ...
                        <div class="table-responsive  table-has-actions   table-has-filter ">
                            <div id="botble-page-tables-page-table_wrapper"
                                    ...
                                    <thead>
                                        <tr role="row">
                                            ...
                                            <th title="ID" width="20px" class="column-key-id sorting_desc"
                                                ...
                                                aria-label="IDpaymentby asc">ID
                                            </th>
                                             <th title="ID" width="20px" class="column-key-id sorting_desc"
                                                tabindex="0" aria-controls="botble-page-tables-page-table" rowspan="1"
                                                colspan="1" style="width: 20px;" aria-sort="descending"
                                                aria-label="IDpaymentby asc">PAYMENT ID
                                            </th>
                                            <th title="ID" width="20px" class="column-key-id sorting_desc"
                                                tabindex="0" aria-controls="botble-page-tables-page-table" rowspan="1"
                                                colspan="1" style="width: 20px;" aria-sort="descending"
                                                aria-label="IDpaymentby asc">ORDER TOKEN
                                            </th>
                                            ...
                                            <th title="Created At" width="100px"
                                                ...
                                                colspan="1" style="width: 100px;" aria-label="Created Atpaymentby asc">
                                                Created At
                                            </th>
                                            ...
                                            <tr role="row" class="odd">
                                                    ...
                                                    <div class="text-start">
                                                        <div class="checkbox checkbox-primary table-checkbox">
                                                            <input type="checkbox" class="checkboxes"
                                                                name="{{ $payment->id }}[]" value="">
                                                        </div>
                                                    </div>
                                                </td>
                                                <!-- payment ID column -->
                                                <td class="column-key-id sorting_1">{{ $payment->id }}</td>
                                                <td class="text-start column-key-template">{{ $payment->payment_id }}</td>
                                                <td class="text-start column-key-template">{{ $payment->order_token }}</td>

                                                <!-- Customer name column -->
                                                <td class="text-start column-key-template">
                                              
                                                    @if(isset($orders[$payment->id]))
                                                        <!-- Assuming order has 'details' property, adjust as needed -->
                                                        {{ $orders[$payment->id]->first_name }} {{ $orders[$payment->id]->last_name }}
                                                    @else
                                                        Order not found
                                                    @endif
                                                </td>
                                                ...
                                                <td class="text-end column-key-template">
                                                    <div class="table-actions">
                                                        <a href="{{ route('admin.payments.edit_product_payments', ['id' => $payment->id]) }}"
                                ...
                                <div class="tablbtnprt">
                                    ...
                                    <div class="rghtprt">
                                        <!--Bpaymented Pagination-->
                                        <div class="b-pagination-outer">

                                            <ul id="bpayment-pagination">
