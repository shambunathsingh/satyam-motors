...
@section('content')
    <form action="{{ route('admin.blog.tag.update_tags', ['id' => $ptag->id]) }}" method="post" enctype="multipart/form-data">
        @csrf
        ...
        <div class="main-panel">
            <ol class="breadcrumb" v-pre="">
                ...
                <li><a class="breadcrumb-item">Edit "{{ $ptag->name }}"</a>
                </li>
            </ol>
                            ...
                            <div class="tab-pane active" id="tab_detail">
                                <div class="form-group mb-3">
                                    ...
                                    <input class="form-control" placeholder="Name" data-counter="120" v-pre=""
                                        ...
                                        value="{{ $ptag->name }}" aria-describedby="name-error"><span id="name-error"
                                ...
                                <div class="form-group mb-3 ">
                                    <div id="edit-slug-box" data-field-name="name">
                                        ...
                                        <textarea class="form-control" rows="4" placeholder="Short description" data-counter="400" v-pre=""
                                            name="description" cols="50" id="description" spellcheck="false">{{ $ptag->name }}</textarea>
                ...
                <div class="col-md-3 right-sidebar d-flex flex-column-reverse flex-md-column">
                    ...
                    <div class="form-side-meta-boxes">
                        <div class="widget meta-boxes">
                            <div class="widget-title">
                                <h4><label for="status" class="control-label required" aria-required="true">Status</label>
                                </h4>
                            </div>
                            <div class="widget-body">
                                <div class="ui-select-wrapper form-group ">
                                    <select class="form-control ui-select" v-pre="" id="status" name="status">
                                        <option value="published" {{ $ptag->status == 'published' ? 'selected' : '' }}>
                                            Published
                                        </option>
                                        <option value="draft" {{ $ptag->status == 'draft' ? 'selected' : '' }}>Draft
                                        </option>
                                        <option value="pending" {{ $ptag->status == 'pending' ? 'selected' : '' }}>
                                            Pending
                                        </option>
                                    </select>
