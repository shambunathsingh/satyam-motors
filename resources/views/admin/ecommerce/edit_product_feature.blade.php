...
@section('content')
    <form action="{{ route('admin.ecommerce.update_product_features', ['id' => $pfeature->id]) }}" method="post"
            ...
            <div class="pagesbodyarea">
                <div class="pageinfo">
                    <ul class="d-flex">
                        ...
                        <li><a class="breadcrumb-item">Edit Product Feature</a>
                        </li>
                    </ul>
                </div>
                                ...
                                <div class="tab-pane active" id="tab_detail">
                                    <div class="form-group mb-3">
                                        ...
                                        <input class="form-control" placeholder="Name" data-counter="120" v-pre=""
                                            ...
                                            value="{{ $pfeature->name }}" aria-describedby="name-error">
                                    </div>
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <img src="{{ asset('storage/product_features/' . $pfeature->image) }}"
                                            data-default="{{ asset('storage/product_features/' . $pfeature->image) }}"
                                    ...
                                    <div class="ui-select-wrapper form-group ">
                                        <select class="form-control ui-select" v-pre="" id="status" name="status">
                                            <option value="published"
                                                {{ $pfeature->status == 'published' ? 'selected' : '' }}>
                                                Published</option>
                                            <option value="draft" {{ $pfeature->status == 'draft' ? 'selected' : '' }}>
                                                Draft</option>
                                            <option value="pending"
                                                {{ $pfeature->status == 'pending' ? 'selected' : '' }}>
                                                Pending</option>
                                        </select>
