...
@section('content')
    <form action="{{ route('admin.ecommerce.save_tag') }}" method="post" enctype="multipart/form-data">
        @csrf
            ...
            <div class="pagesbodyarea">
                <div class="pageinfo">
                    <ul class="d-flex">
                        ...
                        <li><a href="{{ route('admin.ecommerce.product_tags') }}" class="breadcrumb-item">Product Tags
                                /</a>
                        </li>
                        <li><a class="breadcrumb-item">New Product Tag</a>
                        </li>
                    </ul>
                </div>
