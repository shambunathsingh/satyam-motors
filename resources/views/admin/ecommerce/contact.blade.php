                                    ...
                                    <thead>
                                        <tr role="row">
                                            ...
                                            <th title="Template" class="text-start column-key-template sorting"
                                             ...
                                             <th title="Template" class="text-start column-key-template sorting"
                                                tabindex="0" aria-controls="botble-page-tables-page-table" rowspan="1"
                                                colspan="1" aria-label="Templateorderby asc" style="">Email
                                            </th>
                                             <th title="Template" class="text-start column-key-template sorting"
                                                tabindex="0" aria-controls="botble-page-tables-page-table" rowspan="1"
                                                colspan="1" aria-label="Templateorderby asc" style="">Phone No
                                            </th>
                                    ...
                                    <tbody>
                                        @foreach ($contacts as $item)
                                            <tr role="row" class="odd">
                                                ...
                                                <td class=" text-start column-key-email">{{ $item->email }}
                                                </td>
                                                 <td class=" text-start column-key-phone">{{ $item->phone }}
                                                </td>
                                                <td class=" text-center column-key-created_at" style="">
                                                    {{ $item->created_at->format('d-m-Y') }}</td>
                                                <td class=" text-center column-key-status" style="">
                                                    <span class="label-warning bg-warning status-label">{{ $item->status }}</span>
                                                </td>
                                                
                                                <td class=" text-center">
                                                    <div class="table-actions">

                                                        <a href="{{ route('admin.ecommerce.edit_contact', ['id' => $item->id]) }}"
                                                            class="btn btn-icon btn-sm btn-primary"
                                                            data-bs-toggle="tooltip" data-bs-original-title="Edit"><i
                                                                class="fa fa-edit"></i></a>
                                                            <a href="{{ route('admin.ecommerce.delete_contact', ['id' => $item->id]) }}"
