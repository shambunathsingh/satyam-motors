...
@section('content')
    <form action="{{ route('admin.ecommerce.update_product_attributes', ['id' => $pattribute->id]) }}" method="post"
        ...
        <div class="main-panel">
            ...
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">Edit Product attributes
                            ...
                            <div class="form-body">
                                <div class="form-group mb-3">
                                    ...
                                    <input class="form-control" data-counter="120" v-pre="" name="title"
                                        value="{{ $pattribute->title }}" type="text" id="title">
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <input class="form-control" data-counter="120" v-pre="" name="slug"
                                        type="text" id="slug" value="{{ $pattribute->slug }}">
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <div class="form-check form-switch ">
                                        ...
                                        <input class="form-check-input" type="checkbox"
                                            ...
                                            {{ $pattribute->use_image_from_product_variation == '1' ? 'checked' : '' }}>
                                    ...
                                    <div class="ui-select-wrapper form-group ">
                                        <select class="form-control ui-select" v-pre="" id="status"
                                            ...
                                            <option value="published"
                                                {{ $pattribute->status == 'published' ? 'selected' : '' }}>Published
                                            </option>
                                            <option value="draft" {{ $pattribute->status == 'draft' ? 'selected' : '' }}>
                                                Draft
                                            </option>
                                            <option value="pending"
                                                {{ $pattribute->status == 'pending' ? 'selected' : '' }}>Pending
                                            </option>
                                        </select>
                                    ...
                                    <div class="ui-select-wrapper form-group ">
                                        <select class="form-control ui-select" v-pre="" id="display_layout"
                                            ...
                                            <option value="dropdown"
                                                {{ $pattribute->display_layout == 'dropdown' ? 'selected' : '' }}>Dropdown
                                                Swatch
                                            </option>
                                            <option value="visual"
                                                {{ $pattribute->display_layout == 'visual' ? 'selected' : '' }}>Visual
                                                Swatch
                                            </option>
                                            <option value="text"
                                                {{ $pattribute->display_layout == 'text' ? 'selected' : '' }}>Text Swatch
                                            </option>
                                        </select>
                                        <svg class="svg-next-icon svg-next-icon-size-16">
                                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20">
                                ...
                                <div class="widget-body">
                                    <div class="form-check form-switch">
                                        ...
                                        <input class="form-check-input" type="checkbox" name="is_searchable"
                                            ...
                                            {{ $pattribute->is_searchable == '1' ? 'checked' : '' }}>
                                ...
                                <div class="widget-body">
                                    <div class="form-check form-switch">
                                        ...
                                        <input class="form-check-input" type="checkbox" name="is_comparable"
                                            value="1" id="flexSwitchCheckDefault"
                                            {{ $pattribute->is_comparable == '1' ? 'checked' : '' }}>
                                ...
                                <div class="widget-body">
                                    <div class="form-check form-switch">
                                        ...
                                        <input class="form-check-input" type="checkbox" name="is_use_in_product_listing"
                                            value="1" id="flexSwitchCheckDefault"
                                            {{ $pattribute->is_use_in_product_listing == '1' ? 'checked' : '' }}>
                                        <!-- <label class="form-check-label" for="flexSwitchCheckDefault">Default switch checkbox input</label> -->
                                    </div>
                            ...
                            <div class="widget meta-boxes">
                                ...
                                <div class="widget-body">
                                    <input class="form-control" placeholder="Order by" v-pre="" name="order"
                                        type="number" value="{{ $pattribute->order }}" id="order">
