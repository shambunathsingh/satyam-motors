...
@section('content')
    <form action="{{ route('admin.ecommerce.store_product_label') }}" method="post" enctype="multipart/form-data">
        @csrf
            ...
            <div class="pagesbodyarea">
                <div class="pageinfo">
                    <ul class="d-flex">
                        ...
                        <li><a class="breadcrumb-item">New Product Label</a>
                        </li>
                    </ul>
                </div>
                                ...
                                <div class="tab-pane active" id="tab_detail">
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <label for="name" class="control-label"
                                            aria-required="true">Color</label>
