...
@section('content')
    <form action="{{ route('admin.ecommerce.update_product_collection', ['id' => $pcollect->id]) }}" method="post"
            ...
            <div class="pagesbodyarea">
                <div class="pageinfo">
                    <ul class="d-flex">
                        ...
                        <li><a class="breadcrumb-item">Edit Product Collection</a>
                        </li>
                    </ul>
                </div>
                                ...
                                <div class="tab-pane active" id="tab_detail">
                                    <div class="form-group mb-3">
                                        ...
                                        <input class="form-control" placeholder="Name" data-counter="120" v-pre=""
                                            ...
                                            aria-describedby="name-error" value="{{ $pcollect->name }}">
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <textarea class="form-control" rows="10" placeholder="Short description" data-counter="400" v-pre=""
                                            name="description" cols="50" spellcheck="false">{{ $pcollect->description }}</textarea>
                                        {{-- <small class="charcounter">
                                    ...
                                    <div class="ui-select-wrapper form-group ">
                                        <select class="form-control ui-select" v-pre="" id="status" name="status">
                                            <option value="published"
                                                {{ $pcollect->status == 'published' ? 'selected' : '' }}>
                                                Published</option>
                                            <option value="draft" {{ $pcollect->status == 'draft' ? 'selected' : '' }}>
                                                Draft
                                            </option>
                                            <option value="pending"
                                                {{ $pcollect->status == 'pending' ? 'selected' : '' }}>
                                                Pending
                                            </option>
                                        </select>
                                ...
                                <div class="widget-body">
                                    <div class="image-box">
                                        <div class="preview-image-wrapper">
                                            <img src="{{ asset('storage/product_collections/' . $pcollect->image) }}"
                                                data-default="{{ asset('storage/product_collections/' . $pcollect->image) }}"
