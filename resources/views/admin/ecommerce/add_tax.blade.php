...
@section('content')
    <form action="{{ route('admin.ecommerce.store_tax') }}" method="post" enctype="multipart/form-data">
        @csrf
            ...
            <div class="pagesbodyarea">
                <div class="pageinfo">
                    <ul class="d-flex">
                        ...
                        <li><a class="breadcrumb-item">Create a Tax</a>
                        </li>
                    </ul>
                </div>
                        ...
                        <div class="tabbable-custom">
                            <div class="tab-content">
                                <div class="tab-pane active" id="tab_detail">
                                    ...
                                    <div class="form-group mb-3">
                                        <label for="name" class="control-label required"
                                            aria-required="true">Percentage %</label>
