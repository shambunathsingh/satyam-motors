    ...
    <div class="page-content " style="min-height: 758px;">
        <div id="main">
            ...
            <div class="breadcambarea">
                ...
                @endif
                <div class="portlet light bcustomered portlet-no-padding">
                        ...
                        <div class="table-responsive  table-has-actions   table-has-filter ">
                            <div id="botble-page-tables-page-table_wrapper"
                                    ...
                                    <thead>
                                        <tr role="row">
                                            ...
                                            <th title="ID" width="20px" class="column-key-id sorting_desc"
                                                ...
                                                aria-label="IDcustomerby asc">ID
                                            </th>
                                            ...
                                            colspan="1" style="width: 100px;" aria-label="Created Atcustomerby asc">
                                            Created At</th>
                                ...
                                <div class="tablbtnprt">
                                    ...
                                    <div class="rghtprt">
                                        <!--Bcustomered Pagination-->
                                        <div class="b-pagination-outer">

                                            <ul id="bcustomer-pagination">
