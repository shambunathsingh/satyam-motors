...
@section('content')
    <form action="{{ route('admin.update_documents', ['id' => $document->id]) }}" method="post" enctype="multipart/form-data">
        @csrf
        @method('post')
            ...
            <div class="pagesbodyarea">
                <div class="pageinfo">
                    <ul class="d-flex">
                        ...
                        <li><a href="{{ route('admin.documents') }}" class="breadcrumb-item">Documents
                                /</a>
                        </li>
                        <li><a class="breadcrumb-item">Edit {{ $document->name }}</a>
                        </li>
                    </ul>
                </div>
                                ...
                                <div class="tab-pane active" id="tab_detail">
                                    <div class="form-group mb-3">
                                        ...
                                        <input class="form-control" placeholder="Name" data-counter="120" v-pre=""
                                            ...
                                            aria-describedby="name-error" value="{{ $document->name }}">
                                    ...
                                    <div class="ui-select-wrapper form-group ">
                                        <select class="form-control ui-select" v-pre="" id="status" name="status">
                                            <option value="published"
                                                {{ $document->status == 'published' ? 'selected' : '' }}>Published</option>
                                            <option value="draft" {{ $document->status == 'draft' ? 'selected' : '' }}>
                                                Draft</option>
                                            <option value="pending" {{ $document->status == 'pending' ? 'selected' : '' }}>
                                                Pending</option>
                                        </select>
                                ...
                                <div class="widget-body">
                                    <div class="image-box">
                                        <div class="preview-image-wrapper">
                                            <img src="{{ asset('uploads/' . $document->icon) }}" alt="Preview image"
